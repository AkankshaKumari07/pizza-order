const FoodData = [
    ...
    // New items
    {
      ...
      name: "Pasta Salad",
      price: 110,
      desc: "Enjoy a refreshing pasta salad with a mix of colorful vegetables, olives, and a tangy vinaigrette. Perfect as a side dish or light meal.",
      category: "Lunch",
      rating: 4.3,
    },
    {
      id: 22,
      img: "https://png.pngtree.com/png-clipart/20190921/original/pngtree-yellow-sushi-rolls-png-image_4751146.jpg",
      name: "Chocolate Cake",
      price: 180,
      desc: "Delight in a rich and decadent chocolate cake with layers of smooth frosting and a moist, chocolatey crumb. A perfect treat for any occasion.",
      category: "Dessert",
      rating: 4.7,
    },
    {
      id: 23,
      img: "https://images.rawpixel.com/image_800/cHJpdmF0ZS9sci9pbWFnZXMvd2Vic2l0ZS8yMDI0LTAxL3Jhd3BpeGVsX29mZmljZV80OF9waG90b19vZl9jaGlja2VuX2JpcnlhbmlfcmVhbGlzdGljX3NpbXBsZV9pc19jMzljOTY5Yy1mODdmLTQ3MjMtYjkxYi0xNmE0MWNmN2U4ZGRfMS5qcGc.jpg",
      name: "Berry Smoothie",
      price: 90,
      desc: "Cool down with a refreshing berry smoothie made with a blend of strawberries, blueberries, and bananas. A delicious and nutritious drink option.",
      category: "Breakfast",
      rating: 4.6,
    },
    {
      ...
      name: "Falafel Wrap",
      price: 120,
      desc: "Enjoy a savory falafel wrap filled with crispy falafel balls, fresh veggies, and a tangy tahini sauce. A flavorful and satisfying option.",
      category: "Lunch",
      rating: 4.4,
    },
    {
      id: 25,
      img: "https://images.rawpixel.com/image_png_800/cHJpdmF0ZS9sci9pbWFnZXMvd2Vic2l0ZS8yMDIzLTA4L3Jhd3BpeGVsb2ZmaWNlNl9pbGx1c3RyYXRpb25fb2ZfZ2FybGljX2JyZWFkX2lzb2xhdGVkX29uX3doaXRlX18wN2NhNmRjYS1iZWYxLTQ1ODAtYTM4MC05ODQ1MjIyMzBiOTFfMS5wbmc.png",
      name: "Tiramisu",
      price: 150,
      desc: "Indulge in a classic Italian dessert with layers of coffee-soaked ladyfingers and mascarpone cream. A rich and creamy treat.",
      category: "Dessert",
      rating: 4.8,
    },
    {
      id: 26,
      img: "https://e7.pngegg.com/pngimages/589/674/png-clipart-sushi-sashimi-california-roll-japanese-cuisine-gimbap-sushi-roll-food-recipe.png",
      name: "California Roll",
      price: 140,
      desc: "Savor the flavors of a California roll with fresh avocado, cucumber, and crab meat. A popular sushi choice that's both tasty and satisfying.",
      category: "Dinner",
      rating: 4.5,
    },
    {
      ...
      price: 220,
      desc: "Enjoy a perfectly grilled ribeye steak with a juicy, tender texture and a flavorful char. Served with a side of roasted vegetables.",
      category: "Dinner",
      rating: 4.9,
    },
    {
      id: 28,
      img: "https://w7.pngwing.com/pngs/198/260/png-transparent-garlic-bread-bruschetta-baguette-white-bread-bread-baked-goods-food-recipe.png",
      name: "Garlic Bread",
      price: 60,
      desc: "Relish the aroma of freshly baked garlic bread, topped with a mix of garlic, butter, and herbs. A perfect side for any meal.",
      category: "Snacks",
      rating: 4.4,
    },
  ];
